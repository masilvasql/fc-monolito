...
import { GenerateInvoiceFacadeInputDto } from "./DTO/invoce-facade.dto";
...
describe("InvoiceFacade Test ", () => {
    ...
    it("should create a invoice", async () => {
        ...
        const facade = new InvoiceFacade({generateInvoice:generateInvoiceUseCase,findInvoice:findInvoiceUseCase})
